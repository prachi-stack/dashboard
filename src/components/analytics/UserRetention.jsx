...
const UserRetention = () => {
	return (
		<motion.div
			className='bg-brown-600 bg-opacity-50 backdrop-filter backdrop-blur-lg shadow-lg rounded-xl p-6 border border-brown-500'
			initial={{ opacity: 0, y: 20 }}
			animate={{ opacity: 1, y: 0 }}
			transition={{ delay: 0.5 }}
		>
			<h2 className='text-xl font-semibold text-brown-100 mb-4'>User Retention</h2>
